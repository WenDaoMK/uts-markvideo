...
- **Only include terms specific to this project's context.** General programming
  concepts do not belong even if the project uses them extensively. Before
  adding a term, ask whether it is unique to this context.
...
- **Write an example dialogue.** A conversation between a dev and a domain
  expert should demonstrate how the terms interact naturally and clarify
