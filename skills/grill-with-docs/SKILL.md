...
description: "Grilling session that challenges a plan against the existing domain model, sharpens terminology, and updates documentation such as CONTEXT.md and ADRs inline as decisions crystallise. Use when the user wants grill-with-doc, grill-with-docs, or to stress-test a plan against project language and documented decisions."
---
...
Don't couple `CONTEXT.md` to implementation details. Only include terms that
